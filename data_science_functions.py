...
def create_result_features_pre_embed(results: pl.DataFrame, races: pl.DataFrame) -> pl.DataFrame:
    ...
    discrete_features_to_bucket_on = [
        "cluster_name"
    ]
    continuous_features_to_bucket_on = [
        # "distance_km",
        # "elevation_m",
        # "profile_score",
        # "profile_score_last_25k",
    ...
    races_bucketed = races.with_columns(
        [
            ...
            for c in continuous_features_to_bucket_on
        ]
    )
    ...
    feature_creation_expressions = [
        ...
        for bucket_feature in continuous_features_to_bucket_on
        for bucket in ["1", "2", "3"]
